...
//
// Value is always a string. It is an empty string whenever Secret
// is 1 or the variable has no stored value; ordinary reads never
// return secret plaintext (issue #29).
//
