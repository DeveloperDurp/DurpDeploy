...
var actionMap = map[string]string{
	...
	"POST /admin/pools":                                    "create_agent_pool",
	"PUT /admin/pools/{id}":                                "update_agent_pool",
	"POST /admin/pools/{id}/disable":                       "disable_agent_pool",
	"POST /admin/pools/{id}/members":                       "add_agent_pool_member",
	"DELETE /admin/pools/{id}/members":                     "remove_agent_pool_member",
	"POST /admin/agents":                                   "create_agent",
	"DELETE /admin/agents/{agentID}":                       "delete_agent",
	"POST /admin/agents/{agentID}/disable":                 "disable_agent",
	"POST /admin/agents/{agentID}/revoke":                  "revoke_agent",
	"POST /admin/agents/{agentID}/reenroll":                "reenroll_agent",
	"POST /admin/agents/{agentID}/enrollment":              "create_agent_enrollment",
