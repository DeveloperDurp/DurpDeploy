...
INSERT INTO deployments (release_id, environment_id, status, started_at, finished_at, forced, note) VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id, release_id, environment_id, status, started_at, finished_at, created_at, forced, note, parent_deployment_id, target_agent_id, target_agent_name
`
...
SELECT id, release_id, environment_id, status, started_at, finished_at, created_at, forced, note, parent_deployment_id, target_agent_id, target_agent_name FROM deployments WHERE release_id = ? AND environment_id = ?
...
SELECT id, release_id, environment_id, status, started_at, finished_at, created_at, forced, note, parent_deployment_id, target_agent_id, target_agent_name FROM deployments WHERE environment_id = ? AND status = 'succeeded'
AND parent_deployment_id IS NULL ORDER BY created_at DESC LIMIT 1
`
...
SELECT id, release_id, environment_id, status, started_at, finished_at, created_at, forced, note, parent_deployment_id, target_agent_id, target_agent_name FROM deployments WHERE environment_id = ?
