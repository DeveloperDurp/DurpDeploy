...
var actionMap = map[string]string{
	...
	"POST /admin/agents/{agentID}/re-pair":                 "repair_agent",
	"POST /admin/agents/{agentID}/pairings":                "create_agent_pairing",
	"POST /admin/agents/{agentID}/pairings/confirm":        "confirm_agent_pairing",
	"POST /admin/agents/{agentID}/assignments":             "assign_environment_agent",
